...
int32_t port_sanity_check(char *port_str)
{
    ...
    if (port > WIFI_PORT_AP) {
        printf("Invalid port argument: %d\n", (int)port);
        return -1;
    }
    return port;
}
...
uint8_t wifi_config_get_mac_address_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_get_mac_address(port%d): (%02x:%02x:%02x:%02x:%02x:%02x), ret:%s, Code=%d\n",
           (int)port,
...
uint8_t wifi_config_set_reload_ex(uint8_t len, char *param[])
{
    ...
    printf("WiFi reload configuration, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
uint8_t wifi_config_set_security_mode_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_security_mode_ex: port:%d, auth mode:%d, encrypt type:%d, ret:%s, Code=%d\n",
...
uint8_t wifi_config_set_psk_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_psk_ex: port:%d, psk(%s), ret:%s, Code=%d\n",
...
uint8_t wifi_config_set_wep_key_ex(uint8_t len, char *param[])
{
    ...
    printf("[%s] save wep key =(%s, %s, %s, %s) key id=%d, len=(%d, %d, %d, %d) done, ret:%s, Code=%d\n",
           section,
           wep_key.wep_key[0],
           wep_key.wep_key[1],
           wep_key.wep_key[2],
...
uint8_t wifi_config_set_ssid_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_ssid(port:%d), [%s], ret:%s, Code=%d\n", (int)port, param[1], WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
    ...
    */
    uint8_t wifi_config_get_bssid_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_bssid(), %02x:%02x:%02x:%02x:%02x:%02x, ret:%s, Code=%d\n",
            bssid[0],bssid[1],bssid[2],bssid[3],bssid[4],bssid[5],WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_set_bssid_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_bssid(), [%s], ret:%s, Code=%d\n",param[0], WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    /**
    ...
    */
    uint8_t wifi_config_get_mtk_smartconnection_filter_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_mtk_smartconnection_filter(flag=0x%x), ret:%s, Code=%d\n",
    ...
    */
    uint8_t wifi_config_set_radio_on_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_radio(onoff=%d), ret:%s, Code=%d\n", flag, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_get_radio_on_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_radio(onoff=%d), ret:%s, Code=%d\n", (int)flag, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_get_wireless_mode_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_wireless_mode(mode=%d), ret:%s, Code=%d\n", mode, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_get_country_region_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_country_region(band:%d), region:%d, ret:%s, Code=%d\n",
               band, region, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_set_country_region_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_country_region(band:%d, region:%d), ret:%s, Code=%d\n",
               band, region, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_set_country_code_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_country_code_ex, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_get_country_code_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_country_code_ex, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        os_free(country_code);
        return status;
    }
    ...
    */
    uint8_t wifi_config_get_dtim_interval_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_dtim_interval dtim:%d, ret:%s, Code=%d\n", dtim, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_set_dtim_interval_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_dtim_interval dtim:%d, ret:%s, Code=%d\n", dtim, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_get_listen_interval_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_listen_interval listen:%d, ret:%s, Code=%d\n", listen, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_set_listen_interval_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_listen_interval listen:%d, ret:%s, Code=%d\n", listen, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_connect_get_station_list_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_connection_get_sta_list, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_connect_get_max_station_number_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_connect_get_max_station_number_ex: max sta number=%d, ret:%s, Code=%d\n",
               number, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_connect_get_rssi_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_connect_get_rssi_ex(rssi=%d), ret:%s, Code=%d\n", rssi, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_connect_set_connection_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_connect_set_connection_ex(link=%d), ret:%s, Code=%d\n", link, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_connect_get_link_status_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_connect_get_link_status(link=%d), ret:%s, Code=%d\n", link, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    int mtk_event_handler_sample(wifi_event_t event_id, unsigned char *payload, unsigned int len)
    {
        ...
        switch (event_id) {
            ...
            case WIFI_EVENT_IOT_DISCONNECTED:
                handled = 1;
                for( i=0;i<len;i++){
                    printf("[MTK Event Callback Sample], p[i]=%02x \n",payload[i]);
                }
                if ((len == WIFI_MAC_ADDRESS_LENGTH) && (payload)) {
    ...
    */
    uint8_t wifi_connect_set_event_callback_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_connect_set_event_callback(), ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    int wlan_raw_pkt_rx_filter_sample(uint8_t *payload, unsigned int len)
    {
        ...
        //printf("payload length=%d, rssi:%d, data rate: %d.%d Mbps\n", data_info.packet_payload_len, data_info.rssi, data_info.data_rate/10, data_info.data_rate%10);
        //printf("mac header,0x%x 0x%x \n",data_info.mac_header[0],data_info.mac_header[1]);
        retry = (data_info.mac_header[1]>>3)&0x1;
        if( retry ){
            printf("Duplicate frames\r\n");
        }
        frame_type = (data_info.mac_header[0]>>2)&0x3;
        if( 0==frame_type ){ /*bit2bi3=00,Management frame*/
            type = (data_info.mac_header[0])>>4;
            switch (type) {
                case 0: printf("Management frame, Association request\r\n");break;
                case 1: printf("Management frame, Association response\r\n");break;
                case 2: printf("Management frame, Reassociation request\r\n");break;
                case 3: printf("Management frame, Reassociation response\r\n");break;
                case 4: printf("Management frame, Probe request\r\n");break;
                case 5: printf("Management frame, Probe response\r\n");break;
                case 8: printf("Management frame, Beacon\r\n");break;
                case 9: printf("Management frame, Announcement traffic indication message (ATIM)\r\n");break;
                case 10: printf("Management frame, Disassociation\r\n");break;
                case 11: printf("Management frame, Authentication\r\n");break;
                case 12: printf("Management frame, Deauthentication\r\n");break;
                default:
                    //printf("wrong management frame\r\n");
                    break;
            }
        }else if( 1==frame_type ){ /*bit2bi3=01,Control frame*/
            type = (data_info.mac_header[0])>>4;
            switch (type) {
                case 11: printf("Control frame, Request To Send (RTS)\r\n");break;
                case 12: printf("Control frame, Clear To Send (CTS)\r\n");break;
                default:
                    break;
            }
        }
    ...
    */
    uint8_t wifi_config_set_bandwidth_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_bandwidth(port%d): %d, ret:%s, Code=%d\n",
    ...
    */
    uint8_t wifi_config_set_bandwidth_extended_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_bandwidth_extended(port%d): %d, %d, ret:%s, Code=%d\n",
               (int)port,  bw, below_above_ch,  WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_config_get_bandwidth_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_bandwidth(port%d): %d, ret:%s, Code=%d\n",
               (int)port, bw, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_config_set_channel_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_channel(port%d): %d, ret:%s, Code=%d\n",
    ...
    */
    uint8_t wifi_config_get_bandwidth_extended_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_bandwidth_extended(port%d): %d, %d, ret:%s, Code=%d\n",
               (int)port,  bw, below_above_ch, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_config_get_channel_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_channel(port%d): %d, ret:%s, Code=%d\n",
               (int)port, ch, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_config_set_rx_filter_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_rxfilter: 0x%x, ret:%s, Code=%d\n",
               (unsigned int) flag, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_config_get_rx_filter_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_rxfilter: 0x%x, ret:%s, Code=%d\n",
               (unsigned int) flag, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_config_set_rx_raw_pkt_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_rx_raw_pkt_ex, enable = %d, ret:%s, Code=%d\n",
    ...
    */
    uint8_t wifi_tx_raw_pkt_ex(uint8_t len, char *param[])
    {
        ...
        printf("tx raw packet, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        os_free(hex_buf);
        return status;
    }
    ...
    */
    uint8_t wifi_config_set_pmk_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_pmk_ex: port:%d, ret:%s, Code=%d\n",
    ...
    */
    uint8_t wifi_config_get_security_mode_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_security_mode_ex: port:%d, auth mode:%d, encrypt type:%d, ret:%s, Code=%d\n",
               (int)port, auth, encrypt, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_config_get_psk_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_psk_ex: port:%d, psk(%s), ret:%s, Code=%d\n",
    ...
    */
    uint8_t wifi_config_get_pmk_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_pmk_ex: port:%d, ret:%s, Code=%d, key dump:\n",
               (int)port, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_config_get_wep_key_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_wep_ex: port:%d, ret:%s, Code=%d\n",
               (int)port, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_config_get_ssid_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_get_ssid(port:%d), [%s], ret:%s, Code=%d\n", (int)port, ssid, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_config_set_wireless_mode_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_config_set_wireless_mode(mode=%d), ret:%s, Code=%d\n", mode, WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_connect_deauth_station_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_connect_deauth_station(%02x:%02x:%02x:%02x:%02x:%02x), ret:%s, Code=%d\n",
    ...
    */
    ...
    uint8_t wifi_connect_set_scan_ex(uint8_t len, char *param[])
    {
        ...
        printf("wifi_connect_set_scan_ex(), ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
#endif
...
*/
    ...
    uint8_t wifi_wps_set_device_info_ex(uint8_t len, char *param[]) {
        ...
        printf("wifi_wps_set_device_info_ex(), ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_wps_set_auto_connection_ex(uint8_t len, char *param[]) {
        ...
        printf("wifi_wps_set_auto_connection_ex(), ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_wps_get_device_info_ex(uint8_t len, char *param[]) {
        ...
        printf("wifi_wps_get_device_info_ex(), ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_wps_get_auto_connection_ex(uint8_t len, char *param[]) {
        ...
        printf("wifi_wps_get_auto_connection_ex(onoff=%d), ret:%s, Code=%d\n",
               auto_connection, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_wps_get_pin_code_ex(uint8_t len, char *param[]) {
        ...
        printf("wifi_wps_get_pin_code_ex (PIN:%s), ret:%s, Code=%d\n", pin_code, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    ...
    */
    uint8_t wifi_wps_connection_by_pbc_ex(uint8_t len, char *param[]) {
        ...
        printf("wifi_wps_connection_by_pbc_ex(), ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
    ...
    */
    uint8_t wifi_wps_connection_by_pin_ex(uint8_t len, char *param[]) {
        ...
        printf("wifi_wps_connection_by_pin_ex(), ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
        return status;
    }
