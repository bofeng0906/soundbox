...
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
* @note This API is only supported in the station mode, AP mode or monitor mode.
*/
...
* @return   >=0 the operation completed successfully, <0 the operation failed.
*
* @note When the scan is finished, #wifi_connection_scan_deinit() should be called to unload the buffer from the Wi-Fi driver. After that, the data in the parameter ap_list can be safely processed by user applications, and then another scan can be initialized by calling #wifi_connection_scan_init().
*/
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function stores the operation mode in a profile in the Flash memory. \n
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function gets the operation mode from a profile in the Flash memory.
*
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function stores the bandwidth in a profile in the Flash memory. \n
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function gets the MAC address of the Wi-Fi interface from a profile in the Flash memory.
*
* @param[in] port indicates the Wi-Fi port that the function will operate on.
*
* Value                         |Definition                                                              |
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function sets the MAC address of the Wi-Fi interface in a profile in the Flash memory.
* It uses the same profile section for a specific wireless port, such as #WIFI_PORT_STA / #WIFI_PORT_APCLI.
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function stores the SSID in a profile in the Flash memory. \n
* It uses the same profile section for a specific wireless port, such as #WIFI_PORT_STA / #WIFI_PORT_APCLI.
* The profile is read to initialize the system at boot up.
*
* @param[in] port indicates the Wi-Fi port that the function will operate on.
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function stores the Wi-Fi Wireless Mode in a profile in the Flash memory. \n
* It uses the same profile section for a specific wireless port, such as #WIFI_PORT_STA / #WIFI_PORT_APCLI.
* The profile is read to initialize the system at boot up.
*
* @param[in] port indicates the Wi-Fi port that the function will operate on.
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function stores the Wi-Fi authentication mode and encryption type in a profile in the Flash memory.
* It uses the same profile section for a specific wireless port, such as #WIFI_PORT_STA / #WIFI_PORT_APCLI.
* The profile is read to initialize the system at boot up.
*
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function stores the Wi-Fi WPAPSK/WPA2PSK passphrase in a profile in the Flash memory. \n
* It uses the same profile section for a specific wireless port, such as #WIFI_PORT_STA / #WIFI_PORT_APCLI.
* The profile is read to initialize the system at boot up.
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function gets the PMK from a profile in the Flash memory.
* @param[in] port indicates the Wi-Fi port that the function will operate on.
*
* Value                         |Definition                                                              |
* ------------------------------|------------------------------------------------------------------------|
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function stores Wi-Fi WEP Keys in a profile in the Flash memory.
* It uses the same profile section for a specific wireless port, such as #WIFI_PORT_STA / #WIFI_PORT_APCLI.
* The profile is read to initialize the system at boot up.
*
* @param[in] port indicates the Wi-Fi port that the function will operate on.
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function gets the Wi-Fi Country Region used in the Wi-Fi driver.
* Various world regions have allocated different amounts of frequency space
* around 2.4GHz for Wi-Fi and some of them have fewer or more channels
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function sets the Wi-Fi Country Region in a profile in the Flash memory.
* Various world regions have allocated different amounts of frequency space
* around 2.4GHz for Wi-Fi and some of them have fewer or more channels
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function gets the Wi-Fi DTIM interval from a profile in the Flash memory.
*
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function sets the Wi-Fi DTIM interval in a profile in the Flash memory. This API can be used only for STA mode.
* The profile is read to initialize the system at boot up.
*
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function gets the Wi-Fi Listen Interval from a profile in the Flash memory.
*
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function sets the Wi-Fi Listen Interval in a profile in the Flash memory. This API can be used only for STA mode.
* The profile is read to initialize the system at boot up.
*
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function stores the Wi-Fi Power Save mode in a profile in the Flash memory. \n
* The profile is read to initialize the system at boot up.
*
...
/**
* @deprecated This function is deprecated! For more information, please refer to Airoha IoT SDK for RTOS Wi-Fi Migration Developer's Guide under the doc folder in the SDK package. This function is not implemented.
*/
