...
//#ifdef MTK_AUDIO_I2S_REC_ENABLED
//#include "i2s_rec.h"
//#include "task_def.h"
//#endif
...
#if defined(MTK_AUDIO_MP3_ENABLED)
    //create mp3 codec unit test
	xTaskCreate(mp3_codec_demo, MP3_PLAY_EXAMPLE_TASK_NAME, MP3_PLAY_EXAMPLE_TASK_STACKSIZE/sizeof(StackType_t), NULL, MP3_PLAY_EXAMPLE_TASK_PRIO, NULL);
#endif

#ifdef MTK_AUDIO_AMR_ENABLED
      printf("AMR_codec_demo\n");

#ifdef MTK_AUDIO_AMR_FEATURE_ENCODE_DEMO
      /*Demo :Encode pcm stream from sd card and output it to sd card*/
      printf("AMR_encoder_demo\n");
      xTaskCreate(amr_encoder_demo, AMR_ENCODER_DEMO_NAME, AMR_ENCODER_DEMO_STACKSIZE, NULL, AMR_ENCODER_DEMO_PRIO, NULL);
#endif

#ifdef MTK_AUDIO_AMR_FEATURE_DECODE_DEMO
      /*Demo :Decoder amr stream from sd card and output it to nau8810*/
      printf("AMR_decoder_demo\n");
      xTaskCreate(amr_decoder_demo, AMR_DECODER_DEMO_NAME, AMR_DECODER_DEMO_STACKSIZE, NULL, AMR_DECODER_DEMO_PRIO, NULL);
#endif
#endif // #ifdef MTK_AUDIO_AMR_ENABLED
